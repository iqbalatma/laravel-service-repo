 ...
 * @method int delete()
 * @method static BaseRepository with(array|string $relations, Closure|null|string $callback)
 * @method BaseRepository with(array|string $relations, Closure|null|string $callback)
