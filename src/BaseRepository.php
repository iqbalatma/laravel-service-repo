 ...
 * @method static BaseRepository where(array|string $column, ?string $operator = null, mixed $value = null, ?string $boolean = 'and')
 * @method BaseRepository where(array|string $column, ?string $operator = null, mixed $value = null, ?string $boolean = 'and')
 * @method static BaseRepository orWhere(array|string $column, ?string $operator = null, mixed $value = null)
 * @method BaseRepository orWhere(array|string $column, ?string $operator = null, mixed $value = null)
 * @method static BaseRepository whereNot($column, ?string $operator = null, mixed $value = null, ?string $boolean = 'and')
 * @method BaseRepository whereNot($column, ?string $operator = null, mixed $value = null, ?string $boolean = 'and')
 * @method static BaseRepository whereBetween(string $column, iterable $values, string $boolean = 'and', bool $not = false)
 * @method BaseRepository whereBetween(string $column, iterable $values, string $boolean = 'and', bool $not = false)
 * @method static BaseRepository whereNotBetween(string $column, iterable $values, string $boolean = 'and')
 * @method BaseRepository whereNotBetween(string $column, iterable $values, string $boolean = 'and')
