...
class GenerateTraitCommand extends Command implements MakeCommandInterface
{
    use MakeCommand;
    ...
    {
        $this->prepareMakeCommand(config("servicerepo.target_trait_dir", "app/Traits"))
            ->generateFromStub();
    }
    ...
    public function getStubContent(): string
    {
         ...
         */
        $overridePath = base_path("stubs/service-repo/trait.stub");
