...
class GenerateInterfaceCommand extends Command implements MakeCommandInterface
{
    use MakeCommand;
    ...
    {
        $this->prepareMakeCommand(config("servicerepo.target_interface_dir", "app/Contracts/Interface"))
            ->generateFromStub();
    }
    ...
    public function getStubContent(): string
    {
         ...
         */
        $overridePath = base_path("stubs/service-repo/interface.stub");
